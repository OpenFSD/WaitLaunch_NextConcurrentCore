...
{
    class ConcurrentQue_Client_Global* ConcurrentQue_Client_LaunchConcurrency::ptr_Global = NULL;
    class ConcurrentQue_Client_LaunchConcurrency_Control* ConcurrentQue_Client_LaunchConcurrency::ptr_LaunchConcurrency_Control = NULL;

    ConcurrentQue_Client_LaunchConcurrency::ConcurrentQue_Client_LaunchConcurrency()
    {
        ptr_Global = new class ConcurrentQue_Client_Global();
    ...
    void ConcurrentQue_Client_LaunchConcurrency::Thread_Start(unsigned char concurrent_CoreId)
    {
        class ConcurrentQue::ConcurrentQue_Client_LaunchConcurrency_Control* ptr_LaunchConcurrency_Control = ConcurrentQue::ConcurrentQue_Client_Framework::Get_LaunchConcurrency()->Get_Control_Of_LaunchConcurrency();
        class ConcurrentQue::ConcurrentQue_Client_Global* ptr_Global = ConcurrentQue::ConcurrentQue_Client_Framework::Get_LaunchConcurrency()->Get_GlobalForLaunchConcurrency();
    ...
    void ConcurrentQue_Client_LaunchConcurrency::Initialise_Control(
        class ConcurrentQue::ConcurrentQue_Client_Global* ptr_Global,
        unsigned char ptr_MyNumImplementedCores
    )
    {
        ptr_LaunchConcurrency_Control = new class ConcurrentQue::ConcurrentQue_Client_LaunchConcurrency_Control(ptr_Global, ptr_MyNumImplementedCores);
        while (ptr_LaunchConcurrency_Control == NULL) { /* wait untill created */ }
    }

    void ConcurrentQue_Client_LaunchConcurrency::Thread_End(unsigned char concurrent_CoreId)
    {
        class ConcurrentQue::ConcurrentQue_Client_LaunchConcurrency_Control* ptr_LaunchConcurrency_Control = ConcurrentQue::ConcurrentQue_Client_Framework::Get_LaunchConcurrency()->Get_Control_Of_LaunchConcurrency();
        class ConcurrentQue::ConcurrentQue_Client_Global* ptr_Global = ConcurrentQue::ConcurrentQue_Client_Framework::Get_LaunchConcurrency()->Get_GlobalForLaunchConcurrency();
    ...
    class ConcurrentQue_Client_LaunchConcurrency_Control* ConcurrentQue_Client_LaunchConcurrency::Get_Control_Of_LaunchConcurrency()
    {
        return ptr_LaunchConcurrency_Control;
    }

    ConcurrentQue_Client_Global* ConcurrentQue_Client_LaunchConcurrency::Get_GlobalForLaunchConcurrency()
    {
        return ptr_Global;
    }
}