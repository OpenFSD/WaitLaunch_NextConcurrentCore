...
{
    bool ConcurrentQue_Client_LaunchConcurrency_Control::state_ConcurrentCore[3] = { NULL, NULL, NULL };//NUMBER OF CONCURRENT CORES
    bool ConcurrentQue_Client_LaunchConcurrency_Control::flag_praisingLaunch = NULL;
    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::concurrent_CoreId_Index = NULL;
    int ConcurrentQue_Client_LaunchConcurrency_Control::count_LaunchActive_For[3] = { NULL, NULL, NULL };//NUMBER OF CONCURNT CORES
    int ConcurrentQue_Client_LaunchConcurrency_Control::count_LaunchIdle_For[3] = { NULL, NULL, NULL };//NUMBER OF CONCURNT CORES
    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::new_concurrent_CoreId_Index = NULL;
    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::que_CoreToLaunch[3] = { NULL, NULL, NULL };//NUMBER OF CONCURRENT CORES
    
    std::vector<unsigned char>* ConcurrentQue_Client_LaunchConcurrency_Control::stack_PriseEventId;

    ConcurrentQue_Client_LaunchConcurrency_Control::ConcurrentQue_Client_LaunchConcurrency_Control(
        ConcurrentQue::ConcurrentQue_Client_Global* ptr_Global,
    ...
    void ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_Activate(
    ...
    void ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_Request(
    ...
    void ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_SortQue(
        class ConcurrentQue::ConcurrentQue_Client_Global* ptr_Global,
        unsigned char number_Implemented_Cores
    )
    {
    ...
    void ConcurrentQue_Client_LaunchConcurrency_Control::LaunchQue_Update(
        unsigned char number_Implemented_Cores
    )
    {
    ...
    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::Get_concurrent_CoreId_Index()
    {
        return concurrent_CoreId_Index;
    }

    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::Get_coreId_To_Launch()
    {
        return que_CoreToLaunch[0];
    }

    bool ConcurrentQue_Client_LaunchConcurrency_Control::Get_State_ConcurrentCore(unsigned char concurrent_CoreId)
    {
        return state_ConcurrentCore[concurrent_CoreId];
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::SetFlag_PraisingLaunch(bool value)
    {
        flag_praisingLaunch = value;
    }

    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::Get_new_concurrent_CoreId_Index()
    {
        return new_concurrent_CoreId_Index;
    }

    std::vector<unsigned char>* ConcurrentQue_Client_LaunchConcurrency_Control::Get_Stack_PriseEventId()
    {
        return stack_PriseEventId;
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::Set_concurrent_CoreId_Index(unsigned char value)
    {
        concurrent_CoreId_Index = value;
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::SetFlag_ConcurrentCoreState(unsigned char concurrent_CoreId, bool value)
    {
        state_ConcurrentCore[concurrent_CoreId] = value;
    }


    bool ConcurrentQue_Client_LaunchConcurrency_Control::GetFlag_PraisingLaunch()
    {
        return flag_praisingLaunch;
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::Set_new_concurrent_CoreId_Index(unsigned char value)
    {
        new_concurrent_CoreId_Index = value;
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::DynamicStagger(
    ...
    void ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_ShiftQueValues(
    ...
    int ConcurrentQue_Client_LaunchConcurrency_Control::Get_count_LaunchActive_For(unsigned char concurrent_CoreId)
    {
        return count_LaunchActive_For[concurrent_CoreId];
    }

    int ConcurrentQue_Client_LaunchConcurrency_Control::Get_count_LaunchIdle_For(unsigned char concurrent_CoreId)
    {
        return count_LaunchIdle_For[concurrent_CoreId];
    }

    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::GetFlag_CoreId_Of_CoreToLaunch()
    {
        return que_CoreToLaunch[0];
    }

    unsigned char ConcurrentQue_Client_LaunchConcurrency_Control::Get_que_CoreToLaunch(unsigned char index)
    {
        return que_CoreToLaunch[index];
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::Set_count_LaunchActive_For(unsigned char concurrent_CoreId, int value)
    {
        count_LaunchActive_For[concurrent_CoreId] = value;
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::Set_count_LaunchIdle_For(unsigned char concurrent_CoreId, int value)
    {
        count_LaunchIdle_For[concurrent_CoreId] = value;
    }

    void ConcurrentQue_Client_LaunchConcurrency_Control::Set_que_CoreToLaunch(unsigned char concurrent_CoreId, unsigned char value)
    {
